...
public class LoginView extends Composite {
	...
	private void initWelcomePanel() {
		...
		Label welcomeText = new Label("Find out where your Facebook friends are located around the World. Filter your Friends by Country and by their updated Location in Facebook");
